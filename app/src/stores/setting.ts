...
export const useSettingsStore = defineStore('settings', () => {
    ...
    function setApplicationLockBiometric(value: boolean): void {
        updateApplicationSettingsValue('applicationLockBiometric', value);
        appSettings.value['applicationLockBiometric'] = value;
    }
